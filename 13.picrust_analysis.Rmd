...
ggsave(file="figures/plot_plat_resist_fuso.pdf", plot=plot_plat_resist_fuso, width=6, height=3)
...
ggsave(file="figures/plot_biofilm_neis.pdf", plot=plot_biofilm_neis, width=4, height=3)
...
ggsave(file="figures/plot_biofilm_camp.pdf", plot=plot_biofilm_camp, width=6, height=3)
```
