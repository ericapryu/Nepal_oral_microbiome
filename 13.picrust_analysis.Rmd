...
plot_pc1 <- ggplot(pca_plot, aes(x = lifestyle, y = as.numeric(PC1), group = lifestyle), color = black) +
  ...
  labs(title = "PC1 by Lifestyle", x = "Lifestyle", y = "PC1 (28.4%)") + 
...
ggsave(file="output/ridge_top_plat_resist_order_plot.pdf", plot=ridge_top_plat_resist_order_plot, width=6, height=4)
...
ggsave(file="output/plot_plat_resist_fuso.pdf", plot=plot_plat_resist_fuso, width=6, height=3)
...
ggsave(file="output/plot_trad_indus_plat_resist_fuso.pdf", plot=plot_trad_indus_plat_resist_fuso, width=6, height=3)
```
...
ggsave(file="output/ridge_top_biofilm_order_plot.pdf", plot=ridge_top_biofilm_order_plot, width=6, height=3)
...
ggsave(file="output/plot_biofilm_neis.pdf", plot=plot_biofilm_neis, width=4, height=3)
...
ggsave(file="output/plot_trad_indus_biofilm_neis.pdf", plot=plot_trad_indus_biofilm_neis, width=4, height=3)
...
ggsave(file="output/plot_biofilm_camp.pdf", plot=plot_biofilm_camp, width=6, height=3)
```
...
model_kw_KO <- read.csv("output/model_kw_KO.csv", row.names = TRUE)
```
