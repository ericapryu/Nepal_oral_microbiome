...
# ggsave(file="figures/ca_plot.svg", plot=CA_plot, width=8, height=6)
```
...
# ggsave(file="figures/dim1_contrib_small.svg", plot=dim1_contrib, width=4, height=2)
# ggsave(file="figures/dim2_contrib_small.svg", plot=dim2_contrib, width=4, height=2)
```
...
# ggsave(file="figures/ca1_axes.svg", plot=ca1_axes, width=4, height=3)
...
# ggsave(file="figures/ca2_axes.svg", plot=ca2_axes, width=4, height=3)
```
...
# ggsave(file="figures/pcoa1_ca1_small.svg", plot=pcoa1_ca1, width=4, height=2)
...
# ggsave(file="figures/pcoa2_ca2_small.svg", plot=pcoa2_ca2, width=4, height=2)
...
# ggsave(file="figures/pcoa3_ca3_small.svg", plot=pcoa3_ca3, width=4, height=2)
...
# ggsave(file="figures/pcoa2_ca1_small.svg", plot=pcoa2_ca1, width=4, height=2)
...
# ggsave(file="figures/pcoa1_ca2_small.svg", plot=pcoa1_ca2, width=4, height=2)
```
...
# ggsave(file="figures/shannon_ca1_small.svg", plot=shannon_ca1, width=4, height=2)
...
# ggsave(file="figures/shannon_ca2_small.svg", plot=shannon_ca2, width=4, height=2)
...
# ggsave(file="figures/faiths_ca1_small.svg", plot=faiths_ca1, width=4, height=2)
...
# ggsave(file="figures/faiths_ca2_small.svg", plot=faiths_ca2, width=4, height=2)

# correlation
cor.test(faiths_CA_comb$mean, faiths_CA_comb$CA2, alternative = "two.sided", method=c("spearman"))
```

## prep OTU table and survey data for CCA
```{r}
### prep OTU table
...
# ggsave(file="figures/CCA.svg", plot=CCA_sig_plot, width=5, height=4)
```