...
# old_rfxn$Lifestyle <- factor(old_rfxn$Lifestyle, ordered = TRUE, levels=c("Foragers", "RecentlySettled", "Agriculturalists", "Expats", "Industrial", "control"))
#
# qiagen_rfxn <- subset(old_rfxn, Condition == "Qiagen")
# psoil_rfxn <- subset(old_rfxn, Condition == "Psoil")
