...
rfxn_micro <- read.csv("output/rarefaction_edit03082024_final.csv", header = TRUE)
...
# ggsave(file = "figures/qiagen_alpha.svg", width = 6, height = 8, plot = qiagen_alpha)
...
# ggsave(file = "figures/qiagen_alpha_plot_obj.svg", width = 6, height = 4, plot = qiagen_alpha_plot_obj)
...
# ggsave(file = "figures/psoil_alpha.svg", width = 6, height = 7, plot = psoil_alpha)
...
simpson_dunn <- dunnTest(mean ~ Lifestyle, data = simpson_qiagen, method="bh")
...
df_simpson_dunn <- simpson_dunn[["res"]]
...
df_simpson_dunn <- df_simpson_dunn[order(df_simpson_dunn$P.adj),]
...
df_simpson_dunn_sig <- df_simpson_dunn[(df_simpson_dunn$P.adj < 0.05),]
df_fisher_dunn_sig <- df_fisher_dunn[(df_fisher_dunn$P.adj < 0.05),]

# add column for diversity metric
df_shannon_dunn_sig$metric <- rep(c("shannon"), times = length(df_shannon_dunn_sig$P.adj))
...
df_simpson_dunn_sig$metric <- rep(c("simpson"), times = length(df_simpson_dunn_sig$P.adj))
df_fisher_dunn_sig$metric <- rep(c("fisher"), times = length(df_fisher_dunn_sig$P.adj))

# combine all sig
df_dunn_sig <- rbind(df_shannon_dunn_sig, df_faiths_dunn_sig, df_rich_dunn_sig, df_simpson_dunn_sig, df_fisher_dunn_sig)
...
# ggsave(file = "figures/bray_small.svg", plot = bray, width = 6, height = 3)
...
# ggsave(file = "figures/bray_pcoa1_small.svg", plot = bray_pcoa1, width = 6, height = 3)
# ggsave(file = "figures/bray_pcoa2_small.svg", plot = bray_pcoa2, width = 6, height = 3)
...
# ggsave(file = "figures/bray_psoil_small.svg", plot = bray_psoil, width = 6, height = 3)
...
# ggsave(file = "figures/bray_pcoa1_psoil_small.svg", plot = bray_pcoa1_psoil, width = 4, height = 3)
...
# ggsave(file = "figures/bray_pcoa2_psoil_small.svg", plot = bray_pcoa2_psoil, width = 4, height = 3)
