...
# ggsave(file = "pcoa_qvp_1.svg", width = 5, height = 3, plot = pcoa_qvp_1)
...
# ggsave(file = "figures/pcoa_qvp_2.svg", width = 5, height = 3, plot = pcoa_qvp_2)

```

## PERMANOVA between kits
```{r}
metadata <- data.frame(sample_data(phyloseq_complete))
dist <- phyloseq::distance(phyloseq_complete, method="bray",normalized=TRUE, parallel=FALSE, fast=TRUE) 
...
# ggsave(file = "figures/extraction_comb.svg", width = 6, height = 4, plot = extraction_comb)
```
