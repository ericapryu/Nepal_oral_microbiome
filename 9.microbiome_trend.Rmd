...
trend_result <- data.frame(matrix(ncol = 3, nrow = 112))
...
## last iteration of trend test will always error as the error pertains to the lifestyle column. ignore error
...
```{r}
# write.csv(trend_result, file = "/Users/ericaryu/Documents/school_stuff/grad_school/PSU/lab/Nepal/Himalayan_oral_microbiome/coding/trend_result.csv")
```
...
# ggsave(file="plot_sig_taxa.svg", plot=plot_sig_taxa, width=7, height=7)
```